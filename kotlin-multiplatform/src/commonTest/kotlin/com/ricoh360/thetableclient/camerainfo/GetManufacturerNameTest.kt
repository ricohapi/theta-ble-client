...
class GetManufacturerNameTest {
    ...
    fun normalTest() = runBlocking {
        ...
        MockBlePeripheral.onRead = {
            assertEquals(it.name, "MANUFACTURER_NAME")
            name.encodeToByteArray()
        }
        val maker = device.cameraInformation?.getManufacturerName()
        assertEquals(maker, name, "getManufacturerName")
    }

    /**
     * Not connected exception for getManufacturerName call.
     */
    @Test
    fun exceptionApiTest() = runBlocking {
        ...
        try {
            ...
            device.disconnect()
            cameraInformation?.getManufacturerName()
    ...
    /**
     * Read exception for getManufacturerName call.
     */
    @Test
    fun exceptionBleTest() = runBlocking {
        ...
        try {
            device.connect()
            device.cameraInformation?.getManufacturerName()
    ...
    /**
     * Read empty for getManufacturerName call.
     */
    @Test
